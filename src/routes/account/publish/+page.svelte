...
<div style='width: 50%; height: 32px; display: flex; justify-content: center; align-items: center; margin: auto; margin-top: 32px; margin-bottom: 32px; background-color: green;'><h1>POST PREVIEW BELOW</h1></div>
